...
// Self-executing function to encapsulate the code and avoid global scope pollution
(self.webpackChunkadmin_portal = self.webpackChunkadmin_portal || []).push([
  [6429], {
    7435: (ie, Ee, de) => {
      de(88583)
    },
    88583: () => {
      ! function(e) {
        ...
        // Function to mark a performance entry
        function i(M) {
          n && n.mark && n.mark(M)
        }
        ...
        // Function to create a symbol unique to Zone.js
        function a(M) {
          return c + M
        }
        const y = !0 === e[a("forceDuplicateZoneCheck")];

        // Check if Zone is already loaded to prevent duplication
        if (e.Zone) {
        ...
        let d = (() => {
          class M {
            ...
            // Static method to assert if Zone.js has patched Promise
            ...
            // Get a property from the Zone or its parents
            get(t) {
              const r = this.getZoneWith(t);
              if (r) return r._properties[t]
            }

            // Get the Zone that has a specific property
            getZoneWith(t) {
              let r = this;
              for (; r;) {
            ...
            // Wrap a function with the current Zone
            wrap(t, r) {
            ...
            // Run a function in the current Zone
            run(t, r, k, C) {
              U = {
                parent: U,
                zone: this
            ...
            // Run a function in the current Zone with error guarding
            ...
            // Run a task in the current Zone
            runTask(t, r, k) {
        ...
        class v {
          ...
          // Schedule a task through the delegate
          scheduleTask(E, t) {
            let r = t;
          ...
          // Invoke a task through the delegate
          invokeTask(E, t, r, k) {
          ...
          // Cancel a task through the delegate
          cancelTask(E, t) {
            let r;
          ...
          // Check if the delegate has a task
          hasTask(E, t) {
            try {
          ...
          // Update task counts for the delegate
      ...
      // Function to wrap a function with the current Zone
      function Ie(e, n) {
        return Zone.current.wrap(e, n)
      }

      // Function to schedule a macrotask
      ...
      // Function to bind arguments to the current Zone
      function Le(e, n) {
        for (let i = e.length - 1; i >= 0; i--) "function" == typeof e[i] && (e[i] = Ie(e[i], n + "_" + i));
        return e
      }

      // Function to check if a property is writable
      function Fe(e) {
      ...
      const Be = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope,
        we = !("nw" in Y) && typeof Y.process < "u" && "[object process]" == Object.prototype.toString.call(Y.process),
        je = !we && !Be && !(!Pe || !Te.HTMLElement),
        Ue = typeof Y.process < "u" && "[object process]" == Object.prototype.toString.call(Y.process) && !Be && !(!Pe || !Te.HTMLElement),
        Re = {},
        We = function(e) {
      ...
      // Patch a property with an "on" prefix
      function qe(e, n, i) {
        let o = ie(e, n);
        if (!o && i && ie(i, n) && (o = {
            enumerable: !0,
      ...
      // Patch all "on" properties of an object
      function Xe(e, n, i) {
        if (n)
      ...
      // Patch a class to track original instances
      function ve(e) {
        const n = Y[e];
        if (!n) return;
      ...
      // Set original delegate on a patched function
      function ue(e, n) {
      ...
      Zone.__load_patch("ZoneAwarePromise", (e, n, i) => {
        ...
        // Check if an object has a then method
        function B(l) {
          return l && l.then
        }
        ...
        // Function to resolve/reject a promise
        function I(l, u) {
          return s => {
            try {
              z(l, u, s)
        ...
        class t {
          ...
          // Handle Promise.allWithCallback
        ...
        // Patch the then method of a Promise constructor
        function C(l) {
          const u = l.prototype,
            s = o(u, "then");
      ...
      // Register event names for Zone.js
      function Je(e, n) {
        const i = (n ? n(e) : e) + ae,
          o = (n ? n(e) : e) + ce,
          c = ke + i,
      ...
      // Patch EventTarget methods (addEventListener, removeEventListener, etc.)
      function dt(e, n, i, o) {
        const c = o && o.add || Oe,
          a = o && o.rm || Se,
      ...
      // Filter properties based on ignore list
      function et(e, n, i) {
      ...
      // Patch properties of an object
      function tt(e, n, i, o) {
        e && Xe(e, et(e, n, i), o)
      }

      // Get "on" properties of an object
      function He(e) {
      ...
      // Patch timers (setTimeout, setInterval, etc.)
      function pe(e, n, i, o) {
        let c = null,
          a = null;
        i += o;
      ...
      Zone.__load_patch("legacy", e => {
        ...
        ve("FileReader")
      }), Zone.__load_patch("on_property", (e, n) => {
        ! function Tt(e, n) {
